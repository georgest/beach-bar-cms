...
export interface ApiAccountAccount extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['cash', 'card']>;
    name: Attribute.String;
...
export interface ApiKitchenItemKitchenItem extends Schema.CollectionType {
  ...
  info: {
    singularName: 'kitchen-item';
    pluralName: 'kitchen-items';
...
export interface ApiProductItemProductItem extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::product-item.product-item', 'name'> &
      Attribute.Required;
    ...
    type: Attribute.Enumeration<['bar', 'kitchen']> &
      Attribute.Required &
      Attribute.DefaultTo<'bar'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::product-item.product-item',
